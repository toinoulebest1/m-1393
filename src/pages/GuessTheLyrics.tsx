    ...
    if (!gameState.isAnswered && gameState.isGameStarted && !isPreloading) {
      ...
      if (audioElement) {
        ...
        const funnyMessages = [
          ...
          "Maman serait pas fière de toi là ! 👵",
          "T'as cru qu'on était en 1999 ? ⏰",
          "Même pas peur de te ban ! 🔨",
          "404 : Éthique not found ! 💻",
          "La triche c'est péché mon fils ! 🙏",
          "Ctrl+Z ta vie et recommence ! ⌨️",
          "Tu veux finir au coin toi ? 🏫",
          "Redis ça en face champion ! 💪",
          "T'as volé le cerveau du voisin ? 🧟",
          "Pinocchio au rapport ! 🤥",
          "On t'a reconnu Roger ! 🕵️",
          "Même Google te désapprouve ! 🔍",
          "Tu fais honte à ta famille ! 👨‍👩‍👧",
          "Allez hop, au piquet ! 📐",
          "Tu mérites un bonnet d'âne ! 🎓",
          "Piégé comme un bleu ! 🔵",
          "Tu veux que j'appelle tes parents ? ☎️",
          "Interdiction de tricher dans l'espace ! 🚀",
          "Même en rêve tu y arrives pas ! 😴",
          "Retourne jouer à la dînette ! 🍰",
          "Tu vas finir en prison mon gars ! 👮",
          "Les tricheurs finissent toujours seuls ! 💔",
          "T'as raté ta vie mon pote ! 😭",
          "Bravo Einstein, t'as tout cassé ! 🧪",
          "C'est pas Fortnite ici ! 🎯",
          "Reviens quand tu seras mature ! 👶",
          "Tu veux un bisou peut-être ? 💋",
          "File dans ta chambre ! 🛏️",
          "Ta mère va le savoir ! 📢",
