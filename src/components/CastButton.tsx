      ...
      <PopoverContent className="w-64 p-2 bg-spotify-dark border-spotify-neutral/20">
        <div className="space-y-2">
          ...
          {devices.length === 0 && !isDiscovering && (
            <p className="text-xs text-spotify-neutral py-2">Aucun appareil trouvé</p>
          )}
              ...
              <li key={device.id}>
                <Button
                  ...
                  className={cn(
                    ...
                    activeDevice?.id === device.id && "bg-spotify-accent/20 text-spotify-accent"
                  )}
                  onClick={() => {
                ...
                >
                  <div className="flex items-center">
                    ...
                    {device.type === 'other' && (
                      <div className="w-4 h-4 mr-2 border border-current rounded-full flex items-center justify-center">
          ...
          {activeDevice && (
            <div className="pt-2 border-t border-spotify-neutral/20">
              <Button
                variant="ghost"
                size="sm"
                onClick={() => {
